...
- [Delegating Administrative Permissions in Active Directory](https://woshub.com/delegate-control-active-directory/) - Configurare le deleghe in Active Directory
- [Using Managed Service Accounts (MSA and gMSA) in Active Directory](https://woshub.com/group-managed-service-accounts-in-windows-server-2012/) - Usare Managed Service Account per avviare servizi e programmare task.
