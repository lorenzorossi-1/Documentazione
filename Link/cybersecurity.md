...
- [Analyzing Windows Malware on Linux: Getting Started Tips and Examples](https://www.youtube.com/watch?v=J85991pPYoc) - Video in cui viene mostrato come analizzare malware scritto per Windows con la distro dedicata REMnux
- [EventLog Analysis](https://amr-git-dot.github.io/forensic%20investigation/EventLog_Analysis/) - Esempi di gestione dei log di Windows e Sysmon con Powershell in ambito DFIR
